...
import kz.petproject.gts_tz.data.network.response.DeleteArticleResponse
...
interface Api {
    ...
    @GET("/api/v1/user/all")
    suspend fun getAllUsers(): Response<List<GetAllUsersResponseItem>>
    ...
    ): Response<WrappedArticleResponse>

    @DELETE("/api/v1/articles/{id}")
    suspend fun deleteArticle(@Path("id") articleId: String): Response<DeleteArticleResponse>
    ...
    suspend fun approveArticle(@Path("id") articleId: String): Response<WrappedArticleResponse>
